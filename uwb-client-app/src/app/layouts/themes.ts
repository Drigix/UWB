export class Themes {
  public static primaryTheme: Map<string, string> = new Map([
    ...
    ['--uwb-table-header-color', '#146d7a'], // Teal (Błękitnozielony)
    ['--uwb-selected-row-light-text', '#ffffff'], // White (Biały)
    ['--uwb-selected-row-light-bg', '#54a7b4'], // Cyan (Cyjan)
    ...
    ['--uwb-table-row-even-selected-background', '#54a7b4'], // Cyan (Cyjan)
  ...
  public static darkTheme: Map<string, string> = new Map([
    ['--uwb-selected-row-light-text', '#ffffff'], // White (Biały)
    ['--uwb-selected-row-light-bg', '#1AAA54'], // Dark Green (Ciemnozielony)
    ...
    // ['--uwb-table-row-even-selected-background', '#1AAA54'], // Dark Green (Ciemnozielony)
